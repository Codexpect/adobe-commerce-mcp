...
import {
  ...
  updateStockItem,
} from "../adobe/inventory/api-inventory";
...
/**
 * Register all inventory management tools
 */
  ...
  server.registerTool(
    ...
    async (args: unknown) => {
      ...
      return toolTextResponse(result, (resp) => {
        ...
        <data>
          Stock item updated successfully. Item ID: ${data}
        </data>
      `;
      });
    }
  ...
  server.registerTool(
    ...
    async (args: unknown) => {
      ...
      return toolTextResponse(result, (resp) => {
        ...
        return `
        <meta>
          <n>Products Salable For Quantity Check</n>
          <endpoint>${endpoint}</endpoint>
          <stockId>${parsed.stockId}</stockId>
  ...
  server.registerTool(
    ...
    async (args: unknown) => {
      ...
      return toolTextResponse(result, (resp) => {
        ...
        return `
        <meta>
          <n>Product Salable For Quantity Check</n>
          <endpoint>${endpoint}</endpoint>
          <sku>${parsed.sku}</sku>
          <stockId>${parsed.stockId}</stockId>
